...
df = pd.read_csv("/Users/vedantkanojiya/Desktop/Vedant kanojiya/MMC INTERNSHIP/RECKON DESKTOP TO MYOB/RECKONS FILES /PAYCHECK/Reckon Desktop Pay Cheque - Sheet1.csv")
...
columns_order = [
    "Date", "Reference number", "Description of transaction", "Account", "Debit Amount", "Credit Amount", "Quantity", "Description", "Job",
...
# Export
output_path = r"/Users/vedantkanojiya/Desktop/Vedant kanojiya/MMC INTERNSHIP/RECKON DESKTOP TO MYOB/RECKONS FILES /PAYCHECK/MYOB - PAYCHECK.xlsx"
df.to_excel(output_path, sheet_name="Paycheck", index=False)
